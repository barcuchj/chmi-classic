...
for file in manifest.json navigation.js navigation.css catalog.js catalog.css content.js classic.css satellite.js satellite.css popup.html popup.css popup.js; do
